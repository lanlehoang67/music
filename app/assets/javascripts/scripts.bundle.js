...
$(function() {
    AppConfig = {
        ...
        materialTab: function() {
            var s = $(".line-tabs .nav-item .active"),
                t = $(".line-tabs .nav-item");
            $(".line-tabs").append("<span class='tabs-link-line'></span>");
            var e = s.position(),
                i = s.parent().width();
            $(".tabs-link-line").stop().css({
                width: i
            }), t.on("click", function() {
        ...
        addFavorite: function() {
            ...
            s.on("click", function(s) {
                ...
                if (i.length && !e.find(".custom-card--labels li .la-heart").length) i.append(t);
                else {
...
$(function() {
        AudioPlayer = {
            ...
            volumeIconClick: function() {
                var s = $('.audio-volume input[type="range"]'),
                    t = $(".audio-volume .btn");
                s.on("change", function() {
                    var s = $(this),
                        e = parseInt(s.val(), 10);
    ...
    function(s, t, e, i) {
        function a(e, i) {
            ...
            var o = t.location.pathname.split("/").pop().split(".")[0],
        ...
        a.Defaults = {
            ...
            var t = this,
                e = "#" + t.options.settingsButtonId,
                i = s("#" + t.options.wrapperId),
                a = s("#header"),
                o = s("#sidebar"),
                n = s("#audioPlayer"),
                l = s(".header-skin"),
            ...
            s.cookie("themeSetting", JSON.stringify(this.cookiesOptions), {
                expires: 7,
                path: "/"
            })
